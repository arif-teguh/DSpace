 ...
 * @version $Revision$
 */
public class JSPSelectMultipleCollectionsStep extends JSPStep
{
    /** JSP which displays HTML for this Class * */
    private static final String SELECT_COLLECTION_JSP = "/submit/select-multiple-collections.jsp";

    /** JSP for the Review step * */
    private static final String REVIEW_JSP = "/submit/review-multiple-collections.jsp";
            ...
            AuthorizeException
    {
         ...
         * selected!
         * 
         * The collection parameter/attribute is mandatory | the item must have an owning collection already
         *
	 * selected.collections = List<Collection> - multiple collections that is selected
         */
	    ...
	    request.setAttribute("the.collection", subInfo.getSubmissionItem().getCollection());
	    request.setAttribute("selected.collections", subInfo.getSubmissionItem().getItem().getCollections());
    ...
    public String getReviewJSP(Context context, HttpServletRequest request,
            HttpServletResponse response, SubmissionInfo subInfo)
    {
	    // TODO: read "selected.collections" attribute OR item.getCollections() and display
	    // don't forget to add "the.collection" attribute, it's not included in the selected.collections 
	    // but may have included if we use item.getCollections
        return REVIEW_JSP;  //at this time, you cannot review what collection you selected.
    }
}
