...
<%--  <div class="jumbotron" style="background: #fff">
    <form method="get" action="<%= request.getContextPath() %>/simple-search" >
  	    <div class="form-group">
            <input type="text" class="form-control" placeholder="<fmt:message key="jsp.layout.navbar-default.search"/>" name="query" id="tequery" size="60"/>
          </div>
          <button type="submit" class="btn btn-primary" style='display: block;margin: auto;'>Search <span class="glyphicon glyphicon-search"></span></button>
