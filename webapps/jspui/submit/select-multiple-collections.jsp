...
<%
    ...
    List<Collection> selectedCollections = (List<Collection>) request.getAttribute("selected.collections");
    Collection col = (Collection) request.getAttribute("the.collection");
    String colID = col.getID().toString();
...
<dspace:layout style="submission" locbar="off"
               navbar="off"
               titlekey="jsp.submit.select-multiple-collection.title"
               nocache="true">
...
%>            
					...
					<dspace:accordcollection checkbox="true" klass="form-control" id="tcollection" collection="<%=colID%>" name="mapped_collections[]"/>
					</div><br/>
